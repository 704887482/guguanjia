...
import cn.nyse.entity.UserExample.Criteria;
import cn.nyse.entity.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String selectByExample(UserExample example) {
        ...
        sql.SELECT("force_update");
        sql.SELECT("down_path");
        sql.SELECT("size");
        sql.SELECT("app_explain");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getForceUpdate() != null) {
            sql.SET("force_update = #{record.forceUpdate,jdbcType=INTEGER}");
        }
        
        if (record.getDownPath() != null) {
            sql.SET("down_path = #{record.downPath,jdbcType=VARCHAR}");
        }
        
        if (record.getSize() != null) {
            sql.SET("size = #{record.size,jdbcType=REAL}");
        }
        
        if (record.getAppExplain() != null) {
            sql.SET("app_explain = #{record.appExplain,jdbcType=VARCHAR}");
        }
        ...
        if (record.getDelFlag() != null) {
            sql.SET("del_flag = #{record.delFlag,jdbcType=VARCHAR}");
        }
